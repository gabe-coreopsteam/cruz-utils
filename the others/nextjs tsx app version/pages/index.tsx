...
// Next.js component for managing the document <head>
import Head from 'next/head'; // Commented out for single-file preview
import { 
  Download, 
  Info, 
  Loader2, 
...
// --- Type Definitions (same as React example) ---
...
// In Next.js, each file in /pages is a route.
// `pages/index.tsx` becomes the homepage (/)
const Home: NextPage = () => {
  ...
  return (
    <div className={`flex h-screen w-full font-sans transition-colors ${
      ...
      {/* <Head>
        ...
        <meta name="description" content="Download VSIX files from VSCode Marketplace" />
...
export default Home; // Export the page component as the default

// --- 1. Downloader Page Component ---
// This component is identical to the React TS version.
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800">
        ...
        {message.text && (
          <div className={`mt-4 flex items-start gap-3 rounded-lg p-4 transition-colors ${
            ...
            message.type === 'success' ? 'bg-green-50 border border-green-200 dark:bg-green-900/2G dark:border-green-500/30' :
