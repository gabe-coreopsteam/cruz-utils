...
const DownloaderPage = ({ isDark }: PageProps) => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Use DownloadDirectoryPath if available (Android), else DocumentDirectoryPath (iOS)
      // Note: On iOS, you might want to use DocumentDirectoryPath and then share/export the file.
    ...
    <View style={pageStyles}>
      ...
      <Text style={textStyles}>
        {Platform.OS === 'android' 
          ...
          : 'Files are saved to the app\'s Documents directory (accessible via Files app).'}
      </Text>
    </View>
  );
};
